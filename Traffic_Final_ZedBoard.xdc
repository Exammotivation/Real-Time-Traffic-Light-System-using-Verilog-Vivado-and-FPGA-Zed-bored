...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {N_RedLed}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {N_AmberLed}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {N_GreenLed}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {E_RedLed}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {E_AmberLed}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {E_GreenLed}];  # "JA8"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {S_RedLed}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {S_AmberLed}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {S_GreenLed}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {W_RedLed}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {W_AmberLed}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {W_GreenLed}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {IR_LED}];  # "JB9"
#set_property PACKAGE_PIN V8 [get_ports {JB10}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {Lcd_Out[5]}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {Lcd_Out[6]}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {Lcd_Out[7]}];  # "JC2_N"
...
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {Rs}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {Rw}];  # "JD1_P"
set_property PACKAGE_PIN V4 [get_ports {En}];  # "JD2_N"
set_property PACKAGE_PIN V5 [get_ports {Lcd_Out[0]}];  # "JD2_P"
set_property PACKAGE_PIN W5 [get_ports {Lcd_Out[1]}];  # "JD3_N"
set_property PACKAGE_PIN W6 [get_ports {Lcd_Out[2]}];  # "JD3_P"
set_property PACKAGE_PIN U5 [get_ports {Lcd_Out[3]}];  # "JD4_N"
set_property PACKAGE_PIN U6 [get_ports {Lcd_Out[4]}];  # "JD4_P"
